...
00- Fade Out preloader
01- Img Hover 3d
02- Show And Hide Sections
03- Animated Lines 
04-  Jqyery Show & Hide Animation Loaded
05- Auto Type Setup
...
$(document).ready(function () {
    ...
    $('.short-info .typed').typed({
        strings: ["<span>Freelancer.</span>&nbsp;", "<span>Ui & Ux Designer.</span>&nbsp;", "<span>Front End Web developer.</span>"],
        loop: true,
        startDelay: 1000,
        backDelay: 2000
    });
